...
/**************************************************************************************************/
$notes.addEventListener('click', () => window.location.href = '/private/notes/notes.html');
$settings.addEventListener('click', () => window.location.href = '/private/groups/groups.html');
$calendar.addEventListener('click', () => window.location.href = '/private/calendar/calendar.html');
$shopping.addEventListener('click', () => window.location.href = '/private/shopping/shopping.html');
